 ...
 * @author Eluenai
 */
@WebServlet(name = "EstabelecimentoWS", urlPatterns = {"/admin/estabelecimento/EstabelecimentoWS"})
public class EstabelecimentoWS extends HttpServlet {
    private EstabelecimentoDAO dao;
    private Estabelecimento obj;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        switch(String.valueOf(acao)){
            case "list":
                ...
                if (request.getParameter("filtro") != null) {
                    try {
                        ...
                        Logger.getLogger(EstabelecimentoWS.class.getName()).log(Level.SEVERE, null, ex);
                    }
                } else {
                    lista = dao.listar();
                }
            ...
            case "edit":
                id = request.getParameter("id");
                dao = new EstabelecimentoDAO();
                Estabelecimento obj = dao.buscarPorChavePrimaria(Long.parseLong(id));
